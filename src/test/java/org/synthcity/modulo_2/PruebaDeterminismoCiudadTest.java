...
public class PruebaDeterminismoCiudadTest {
    ...
    @Test
    void testCiudadPruebaTieneVariosCiclos() {
        Ciudad ciudad = construirCiudadPruebaCompleta();
        ResultadoSimulacion resultado = simulador.simular(ciudad);
        System.out.println("Ciclos ejecutados: " + resultado.getCiclosEjecutados());
        System.out.println("Motivo parada: " + resultado.getMotivoParada());
        assertTrue(resultado.getCiclosEjecutados() >= 2,
                "La ciudad de prueba debería durar al menos 2 ciclos");
    }
    @Test
    void determinismo(){
